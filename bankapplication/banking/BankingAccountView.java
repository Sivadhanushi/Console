...
import com.zsgs.bankapplication.login.LoginView;

public class BankingAccountView {
	Scanner sc = new Scanner(System.in);
    BankAccountController bac;
    public BankingAccountView ()
    {
    ...
    public  void transectionHistory(ArrayList<Transaction> userlist)    {
        System.out.println("--------------------------------------------------");
        System.out.println("Transection History");
for(Transaction us:userlist)
